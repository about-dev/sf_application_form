...
class appDevProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            '8b61c7818fa8956d448c8222f73cb219a6ae0fcc0ba837836b0ba739f362ff76_1' => 'get8b61c7818fa8956d448c8222f73cb219a6ae0fcc0ba837836b0ba739f362ff761Service',
            '8b61c7818fa8956d448c8222f73cb219a6ae0fcc0ba837836b0ba739f362ff76_2' => 'get8b61c7818fa8956d448c8222f73cb219a6ae0fcc0ba837836b0ba739f362ff762Service',
            '8b61c7818fa8956d448c8222f73cb219a6ae0fcc0ba837836b0ba739f362ff76_3' => 'get8b61c7818fa8956d448c8222f73cb219a6ae0fcc0ba837836b0ba739f362ff763Service',
            '9c89d4aee6a58701f7631a96304f7112e7e6084770828ebcea48c5ba0e015ef0_1' => 'get9c89d4aee6a58701f7631a96304f7112e7e6084770828ebcea48c5ba0e015ef01Service',
    ...
    protected function get8b61c7818fa8956d448c8222f73cb219a6ae0fcc0ba837836b0ba739f362ff761Service()
    {
        return $this->services['8b61c7818fa8956d448c8222f73cb219a6ae0fcc0ba837836b0ba739f362ff76_1'] = new \Swift_Transport_Esmtp_Auth_CramMd5Authenticator();
    }
    protected function get8b61c7818fa8956d448c8222f73cb219a6ae0fcc0ba837836b0ba739f362ff762Service()
    {
        return $this->services['8b61c7818fa8956d448c8222f73cb219a6ae0fcc0ba837836b0ba739f362ff76_2'] = new \Swift_Transport_Esmtp_Auth_LoginAuthenticator();
    }
    protected function get8b61c7818fa8956d448c8222f73cb219a6ae0fcc0ba837836b0ba739f362ff763Service()
    {
        return $this->services['8b61c7818fa8956d448c8222f73cb219a6ae0fcc0ba837836b0ba739f362ff76_3'] = new \Swift_Transport_Esmtp_Auth_PlainAuthenticator();
    }
    protected function get9c89d4aee6a58701f7631a96304f7112e7e6084770828ebcea48c5ba0e015ef01Service()
    {
        return $this->services['9c89d4aee6a58701f7631a96304f7112e7e6084770828ebcea48c5ba0e015ef0_1'] = new \Symfony\Component\Form\ResolvedFormTypeFactory();
    }
    protected function getAnnotationReaderService()
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), '/var/www/www.emag/app/cache/dev/annotations', false);
    }
    protected function getAssetic_AssetManagerService()
    {
        $this->services['assetic.asset_manager'] = $instance = new \Assetic\Factory\LazyAssetManager($this->get('assetic.asset_factory'), array('twig' => new \Assetic\Factory\Loader\CachedFormulaLoader(new \Assetic\Extension\Twig\TwigFormulaLoader($this->get('twig')), new \Assetic\Cache\ConfigCache('/var/www/www.emag/app/cache/dev/assetic/config'), false)));
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($this->get('templating.loader'), '', '/var/www/www.emag/app/Resources/views', '/\\.[^.]+\\.twig$/'), 'twig');
        return $instance;
    }
    ...
    protected function getCacheWarmerService()
    {
        ...
        $c = new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TemplateFinder($a, $b, '/var/www/www.emag/app/Resources');
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->setNamespace('sf2orm_default_2433e04aac4a4d81ce9801ee6c687fb63a4e9f0db24f14c2c6f332013328edcc');
        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_2433e04aac4a4d81ce9801ee6c687fb63a4e9f0db24f14c2c6f332013328edcc');
        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_2433e04aac4a4d81ce9801ee6c687fb63a4e9f0db24f14c2c6f332013328edcc');
        ...
        $d->setProxyDir('/var/www/www.emag/app/cache/dev/doctrine/orm/Proxies');
    ...
    {
        return $this->services['file_locator'] = new \Symfony\Component\HttpKernel\Config\FileLocator($this->get('kernel'), '/var/www/www.emag/app/Resources');
    }
    ...
    {
        return $this->services['form.resolved_type_factory'] = new \Symfony\Component\Form\Extension\DataCollector\Proxy\ResolvedTypeFactoryDataCollectorProxy($this->get('9c89d4aee6a58701f7631a96304f7112e7e6084770828ebcea48c5ba0e015ef0_1'), $this->get('data_collector.form'));
    }
    ...
    {
        return $this->services['monolog.handler.main'] = new \Monolog\Handler\StreamHandler('/var/www/www.emag/app/logs/dev.log', 100, true);
    }
    ...
    protected function getProfilerService()
    {
        ...
        $this->services['profiler'] = $instance = new \Symfony\Component\HttpKernel\Profiler\Profiler(new \Symfony\Component\HttpKernel\Profiler\FileProfilerStorage('file:/var/www/www.emag/app/cache/dev/profiler', '', '', 86400), $a);
        $instance->add($c);
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('/var/www/www.emag/app/cache/dev/secure_random.seed', $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['sensio_distribution.webconfigurator'] = new \Sensio\Bundle\DistributionBundle\Configurator\Configurator('/var/www/www.emag/app');
    }
    ...
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('/var/www/www.emag/app/cache/dev/sessions', 'MOCKSESSID', $this->get('session.storage.metadata_bag'));
    }
    ...
    {
        $a = new \Swift_Transport_Esmtp_AuthHandler(array(0 => $this->get('8b61c7818fa8956d448c8222f73cb219a6ae0fcc0ba837836b0ba739f362ff76_1'), 1 => $this->get('8b61c7818fa8956d448c8222f73cb219a6ae0fcc0ba837836b0ba739f362ff76_2'), 2 => $this->get('8b61c7818fa8956d448c8222f73cb219a6ae0fcc0ba837836b0ba739f362ff76_3')));
        $a->setUsername(NULL);
        $a->setPassword(NULL);
        $a->setAuthMode(NULL);
    ...
    {
        return $this->services['templating.helper.code'] = new \Symfony\Bundle\FrameworkBundle\Templating\Helper\CodeHelper(NULL, '/var/www/www.emag/app', 'UTF-8');
    }
    ...
    {
        return $this->services['translator.default'] = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, $this->get('translator.selector'), array('translation.loader.php' => array(0 => 'php'), 'translation.loader.yml' => array(0 => 'yml'), 'translation.loader.xliff' => array(0 => 'xlf', 1 => 'xliff'), 'translation.loader.po' => array(0 => 'po'), 'translation.loader.mo' => array(0 => 'mo'), 'translation.loader.qt' => array(0 => 'ts'), 'translation.loader.csv' => array(0 => 'csv'), 'translation.loader.res' => array(0 => 'res'), 'translation.loader.dat' => array(0 => 'dat'), 'translation.loader.ini' => array(0 => 'ini'), 'translation.loader.json' => array(0 => 'json')), array('cache_dir' => '/var/www/www.emag/app/cache/dev/translations', 'debug' => false));
    }
    protected function getTwigService()
    {
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => false, 'strict_variables' => false, 'exception_controller' => 'twig.controller.exception:showAction', 'autoescape_service' => NULL, 'autoescape_service_method' => NULL, 'cache' => '/var/www/www.emag/app/cache/dev/twig', 'charset' => 'UTF-8', 'paths' => array()));
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\CodeExtension(NULL, '/var/www/www.emag/app', 'UTF-8'));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('/var/www/www.emag/vendor/symfony/symfony/src/Symfony/Bundle/FrameworkBundle/Resources/views', 'Framework');
        $instance->addPath('/var/www/www.emag/vendor/symfony/symfony/src/Symfony/Bundle/SecurityBundle/Resources/views', 'Security');
        $instance->addPath('/var/www/www.emag/vendor/symfony/symfony/src/Symfony/Bundle/TwigBundle/Resources/views', 'Twig');
        $instance->addPath('/var/www/www.emag/vendor/symfony/swiftmailer-bundle/Symfony/Bundle/SwiftmailerBundle/Resources/views', 'Swiftmailer');
        $instance->addPath('/var/www/www.emag/vendor/doctrine/doctrine-bundle/Doctrine/Bundle/DoctrineBundle/Resources/views', 'Doctrine');
        $instance->addPath('/var/www/www.emag/src/Demo/TestBundle/Resources/views', 'DemoTest');
        $instance->addPath('/var/www/www.emag/vendor/symfony/symfony/src/Symfony/Bundle/WebProfilerBundle/Resources/views', 'WebProfiler');
        $instance->addPath('/var/www/www.emag/vendor/sensio/distribution-bundle/Sensio/Bundle/DistributionBundle/Resources/views', 'SensioDistribution');
        $instance->addPath('/var/www/www.emag/app/Resources/views');
        $instance->addPath('/var/www/www.emag/vendor/symfony/symfony/src/Symfony/Bridge/Twig/Resources/views/Form');
        return $instance;
    }
    ...
    protected function getValidator_BuilderService()
    {
        ...
        $instance->addXmlMappings(array(0 => '/var/www/www.emag/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/config/validation.xml'));
    ...
    {
        $this->services['assetic.asset_factory'] = $instance = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), '/var/www/www.emag/app/../web', false);
        $instance->addWorker(new \Symfony\Bundle\AsseticBundle\Factory\Worker\UseControllerWorker());
        return $instance;
    }
    protected function getAssetic_CacheService()
    {
        return $this->services['assetic.cache'] = new \Assetic\Cache\FilesystemCache('/var/www/www.emag/app/cache/dev/assetic/assets');
    }
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), '/var/www/www.emag/app/cache/dev');
    }
    ...
    {
        return array(
            'kernel.root_dir' => '/var/www/www.emag/app',
            'kernel.environment' => 'dev',
            'kernel.debug' => false,
            'kernel.name' => 'app',
            'kernel.cache_dir' => '/var/www/www.emag/app/cache/dev',
            'kernel.logs_dir' => '/var/www/www.emag/app/logs',
            'kernel.bundles' => array(
                ...
                'DemoTestBundle' => 'Demo\\TestBundle\\DemoTestBundle',
            ...
            'session.save_path' => '/var/www/www.emag/app/cache/dev/sessions',
            ...
            'profiler.storage.dsn' => 'file:/var/www/www.emag/app/cache/dev/profiler',
            ...
            'router.resource' => '/var/www/www.emag/app/cache/dev/assetic/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => '/var/www/www.emag/app/cache/dev/twig',
                'charset' => 'UTF-8',
                'paths' => array(
                ),
            ),
            ...
            'swiftmailer.spool.default.memory.path' => '/var/www/www.emag/app/cache/dev/swiftmailer/spool/default',
            ...
            'assetic.cache_dir' => '/var/www/www.emag/app/cache/dev/assetic',
            ...
            'assetic.read_from' => '/var/www/www.emag/app/../web',
            'assetic.write_to' => '/var/www/www.emag/app/../web',
            ...
            'doctrine.orm.proxy_dir' => '/var/www/www.emag/app/cache/dev/doctrine/orm/Proxies',
